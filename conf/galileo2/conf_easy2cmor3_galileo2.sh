...
export ${USERexp:=$USER}
export CART0='/gpfs/scratch/userexternal'
export RUNDIR0='${CART0}/${USERexp}/ece3/${expname}/runtime'
export IFSRESULTS0='${CART0}/${USERexp}/ece3/${expname}/output/Output_${year}/IFS'
export IFSRESULTS0_M1='${CART0}/${USERexp}/ece3/${expname}/output/Output_$(( year - 1 ))/IFS'
export NEMORESULTS0='${CART0}/${USERexp}/ece3/${expname}/output/Output_${year}/NEMO'
export LPJGRESULTS0='${CART0}/${USERexp}/ece3/${expname}/output/Output_${year}/LPJG'
export ECE3_POSTPROC_CMORDIR='${CINECA_SCRATCH}/ece3/${expname}/cmorized/cmor_${year}'
