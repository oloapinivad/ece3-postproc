...
export ${USERexp:=$USER}
[[ -z ${IFSRESULTS0:-} ]] &&  export IFSRESULTS0='/gpfs/scratch/userexternal/${USERexp}/ece3/${EXPID}/output/Output_${year}/IFS'
[[ -z ${NEMORESULTS0:-} ]] && export NEMORESULTS0='/gpfs/scratch/userexternal/${USERexp}/ece3/${EXPID}/output/Output_${year}/NEMO'
...
# ECE3_POSTPROC_HC_NEMO=0         # applied only if available
...
module purge
module_list="intel/pe-xe-2018--binary szip zlib hdf5/1.8.18--intel--pe-xe-2018--binary netcdf/4.6.1--intel--pe-xe-2018--binary netcdff/4.4.4--intel--pe-xe-2018--binary python/2.7.12 nco"
