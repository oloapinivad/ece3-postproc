...
export ${USERexp:=$USER}
[[ -z ${IFSRESULTS0:-} ]] &&  export IFSRESULTS0='/scratch/ms/it/${USERexp}/ece3/${EXPID}/output/Output_${year}/IFS'
[[ -z ${NEMORESULTS0:-} ]] && export NEMORESULTS0='/scratch/ms/it/${USERexp}/ece3/${EXPID}/output/Output_${year}/NEMO'
...
STOREDIR=$PERM/ecearth3/post/hiresclim/
