#!/bin/bash
#SBATCH --job-name=validate_det3_2011
#SBATCH -n1
#SBATCH --mem=100GB
#SBATCH --time=02:59:00
#SBATCH --account=IscrC_C2HEClim
#SBATCH --output /marconi_scratch/userexternal/pdavini0/log/cmorize/validate_ifs_det3_2011_%j.out
#SBATCH --error /marconi_scratch/userexternal/pdavini0/log/cmorize/validate_ifs_det3_2011_%j.err
