...
set cntl_casename = LOLO

set cntl_path_history =  ${DATA_HOME}/ccsm/${cntl_casename}/ 
set cntl_path_climo   =  ${DATA_HOME}/climo/${cntl_casename}/
...
set DIR2EXP = "${EMOP_CLIM_DIR}/diag_${test_casename}_${test_period}/${test_casename}-obs_${test_period}"
...
if ( ${RHOST} != "" ) then
    ...
    echo "Diagnostic page installed on remote host ${RHOST} in ${RWWWD}/${test_casename}-obs_${test_period} !"
