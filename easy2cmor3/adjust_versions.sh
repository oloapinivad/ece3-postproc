...
# Get/set version ("vYYYYMMDD" string) for CMORised data by
# listing version directories or moving files to the appropriate
# directory.
...
usage() {
echo "Usage: $(basename $0) -l | -v <version> [-m] DIR
